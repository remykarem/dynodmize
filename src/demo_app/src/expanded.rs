    ...
    impl entity_core::Entity2 for ComplaintComments {
        fn get_schema() -> entity_core::SchemaV2 {
            let partition_key_def = entity_core::KeyDef {
                ...
                attribute_value: entity_core::CompositeAttributeValue {
                    ...
                    >::from([
                        ...
                        entity_core::Segment {
                            struct_field_name: "comment_date".to_string(),
                            prefix: Some("COMMENT_DATE".to_string()),
                        },
                    ]),
                    prefix: None,
                    suffix: None,
            ...
            let sort_key_def = Some(entity_core::KeyDef {
                attribute_name: "combined_sk".to_string(),
                attribute_value: entity_core::AttributeValue::Composite(entity_core::CompositeAttributeValue {
                    segments: Vec::<
                        entity_core::Segment,
                    >::from([
                        entity_core::Segment {
                            struct_field_name: "complaint_id".to_string(),
                            prefix: Some("COMPLAINT_ID".to_string()),
                        },
                    ]),
                    prefix: None,
                    suffix: None,
            ...
            >::from([
                ...
                entity_core::KeyDef {
                    attribute_name: "type2".to_string(),
                    attribute_value: entity_core::AttributeValue::Composite(entity_core::CompositeAttributeValue {
                        segments: Vec::<
                            entity_core::Segment,
                        >::from([
                            entity_core::Segment {
                                struct_field_name: "type2".to_string(),
                                prefix: None,
                            },
                            entity_core::Segment {
                                struct_field_name: "type2".to_string(),
        ...
        fn to_item(&self) -> serde_json::Value {
            ...
            map.insert(
                ...
                serde_json::Value::String(
                    ...
                    >::from([
                            ...
                            ::alloc::__export::must_use({
                                ::alloc::fmt::format(
                                    format_args!("{0}#{1}", "COMMENT_DATE", self.comment_date),
                                )
                            }),
                        ])
                        .join("#"),
            ...
            let sk_map: ::std::collections::HashMap<String, String> = {
                    ...
                    .extend(
                        <[_]>::into_vec(
                            ::alloc::boxed::box_new([
                                ::alloc::__export::must_use({
                                    ::alloc::fmt::format(
                                        format_args!("{0}#{1}", "COMPLAINT_ID", self.complaint_id),
                                    )
                                }),
                            ]),
                        ),
                ...
                map.insert("combined_sk".to_string(), composite_sk);
                map
            };
            ...
            map.insert(
                "type2".to_string(),
                serde_json::Value::String(
                    Vec::<String>::from([self.type2.to_string(), self.type2.to_string()])
                        .join("#"),
                ),
            );
    ...
    impl entity_core::Entity2 for User {
        fn get_schema() -> entity_core::SchemaV2 {
            ...
            >::from([
                ...
                entity_core::KeyDef {
                    attribute_name: "attribute5".to_string(),
                    attribute_value: entity_core::AttributeValue::Composite(entity_core::CompositeAttributeValue {
                        segments: Vec::<
                            entity_core::Segment,
                        >::from([
                            entity_core::Segment {
                                struct_field_name: "attribute5".to_string(),
                                prefix: None,
                            },
                        ]),
                        prefix: None,
        ...
        fn to_item(&self) -> serde_json::Value {
            ...
            map.insert(
                "attribute5".to_string(),
                serde_json::Value::String(
                    Vec::<String>::from([self.attribute5.to_string()]).join("#"),
                ),
            );
            serde_json::Value::Object(map)
        }
