...
mod entity2tings {
    ...
    impl entity_core::Entity2 for ComplaintComments {
        fn get_schema() -> entity_core::SchemaV2 {
            ...
            let sort_key_def = Some(entity_core::KeyDef {
                ...
                attribute_value: entity_core::AttributeValue::Composite(entity_core::CompositeAttributeValue {
                    ...
                    >::from([
                        ...
                        entity_core::Segment {
                            struct_field_name: "comment_dates".to_string(),
                            prefix: None,
                        },
                    ]),
                    prefix: None,
            ...
            >::from([
                entity_core::KeyDef {
                    attribute_name: "attribute2".to_string(),
                    attribute_value: entity_core::AttributeValue::Composite(entity_core::CompositeAttributeValue {
                        segments: Vec::<entity_core::Segment>::from([]),
                        prefix: None,
                        suffix: None,
                    }),
                },
        ...
        fn to_item(&self) -> serde_json::Value {
            ...
            let sk_map: ::std::collections::HashMap<String, String> = {
                ...
                parts
                    .extend(
                        <[_]>::into_vec(
                            ::alloc::boxed::box_new([
                                self.comment_date.to_string(),
                                self.comment_dates.to_string(),
                            ]),
                        ),
                    );
            ...
            map.insert(
                ...
                serde_json::Value::String(::alloc::vec::Vec::new().join("#")),
            );
